export function About() {
  return (
    <div className="flex flex-col md:flex-row gap-4 mx-10 my-20 h-screen">
      <div className="md:w-1/2 relative">
        <img
          src="./about-section.jpg"
          className="absolute roundex-xl h-[30%] right-[100px] top-[20%]"
        ></img>
        <img src="./about-section1.jpeg" className="h-[70%] w-[70%]"></img>
      </div>
